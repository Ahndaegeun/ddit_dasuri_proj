                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form:form modelAttribute="emp" method="post" class="user" action="/emp/detail">
                                ...
                                <div class="form-group row" id="divEdit">
                                	<div class="col-sm-6 mb-3 mb-sm-0">
		                                <a href="#" id="idUpdate" class="btn btn-primary btn-user btn-block">Modify</a>                                	
                                	</div>
                                	<div class="col-sm-6">
	                                	<a href="#" id="idDelete" class="btn btn-danger btn-user btn-block">Delete</a>
	                                </div>
                                </div>
                                
                                <div class="form-group row" id="divConfirm" style="display:none;">
                                	<div class="col-sm-6 mb-3 mb-sm-0">
		                                <a href="#" id="idOk" class="btn btn-primary btn-user btn-block">Modify</a>                                	
                                	</div>
                                	<div class="col-sm-6">
	                                	<a href="#" id="idCancel" class="btn btn-danger btn-user btn-block">Cancel</a>
	                                </div>
                                </div>
